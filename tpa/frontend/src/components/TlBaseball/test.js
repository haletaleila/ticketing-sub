...
tk.utils = {
	...
	isLocaleGlobal: function () {
		...
		return globalUrlPattern.test(window.location.href);
	},
...
tk.i18n.ko = (function () {
	...
	return {
		...
		"SEAT_TYPE_CAN_NOT_BE_PURCHASE_1": "함께 예매할 수 없는 등급이 선택되어 있습니다.\n선택된 좌석을 해제 후 다시 진행 해 주세요.",
		"SEAT_TYPE_CAN_NOT_BE_PURCHASE_2": "함께 예매할 수 없는 등급입니다.\n선택된 좌석을 해제 후 다시 진행 해 주세요.",
		"PURCHASE_TOTAL_MAXIMUM_N_TICKET": "예매 당 최대 {0}매까지 구매 가능합니다.",
		"PURCHASE_GRADE_MAXIMUM_N_TICKET": "해당 등급은 예매 당 최대 {0}매까지 구매 가능합니다.",
		"THIS_IS_NOT_FOR_SALE": "미판매 영역입니다.",
		"THERE_IS_NO_SEAT_AVAILABLE_FOR_PURCHASE": "선택하신 구역은 구매 가능한 등급이 없습니다.",
		"THERE_IS_NO_SEAT_AVAILABLE_ON_PRESALE_PERIOD": "선예매 기간에 구매 가능한 좌석이 없습니다.",
		"THERE_IS_NO_SEAT_AVAILABLE": "구매 가능한 좌석이 없습니다.",
		"PLEASE_SELECT_SEAT_OF_SAME_GRADE_AS_SELECTED_GRADE": "선택한 등급과 동일한 등급의 좌석을 선택해 주세요.",
		"THIS_SEAT_TYPE_CAN_NOT_BE_PURCHASED_NOW": "해당 등급은 선예매 기간에 예매가 불가능합니다.",


		"SELECTED_SEAT_INFO_SELECT_GRADE": "등급을 먼저 선택 후, 좌석선택 유형을 선택해 주세요.",
		"SELECTED_SEAT_INFO_SELECT_AUTO": "자동배정으로 예매 진행이 가능합니다. 등급 및 매수 선택 후 다음 단계를 선택해 주세요.",
		"SELECTED_SEAT_INFO_SELECT_DIRECT": "직접선택으로 예매 진행이 가능합니다. 좌석을 선택해 주세요.",

		"SELECTED_TYPE": "좌석등급 선택",
		"SELECTED_TYPE_AUTO": "매수선택",
		"SELECTED_TYPE_DIRECT": "직접선택",
		"SELECTED_TYPE_INFO_AUTO": " : 선택된 영역과 상관없이 등급 내 연속된 좌석 선택",
		...
		"plan.seat.auto.info.body": " : 선택된 영역과 상관없이 등급 내 연속된 좌석 선택",
		"plan.seat.self.info": "직접선택",
		"plan.seat.self.info.body": " : 선택된 영역의 좌석 선택",
		"plan.seat.auto.ticket.count": "매수선택",
		"plan.seat.auto.selected.info": "구매할 매수를 선택 후 [다음단계] 버튼을 를 클릭 해 주세요.",
		...
		"denomination.top.alert2": "이내 결제하지 않으실 경우 선점된 좌석이 해제됩니다.",
		"denomination.selected.seat": "선택좌석",
		"denomination.ticket.count": "매수",
		"denomination.addOn.items": "부가상품 선택",
		"denomination.addOn.items.info": "선택하신 상품은 아래 부가상품을 함께 구매하실 수 있습니다.",
		"denomination.total.price": "총 결제금액",
		"denomination.booking.fee": "예매 수수료 포함",
		"denomination.won": "원",
		"denomination.grade.select.alert": "권종을 선택하세요. 최대 까지 예매가능합니다.",
		...
		"delivery.reserver.confirm": "주문자 확인 및 예매처리를 위해 휴대폰번호 및 이메일을 수집하여, 이용목적 달성 이후 파기합니다.",
		...
		"delivery.standard.schedule": "모든 스케줄은 현지 시간 및 날짜를 기준으로 합니다. (KST, GMT +9:00)",
		"delivery.personal.info.title": "개인정보 제3자 정보제공",
		"delivery.personal.info.content.head.first": "엔에이치엔링크㈜가 제공하는 상품 및 서비스를 구매하고자 할 경우, NHN LINK는 고객응대 및 상품정보 안내 등을 위하여 필요한 최소한의 개인정보만을 아래와 같이 제공하고 있습니다.",
		"delivery.personal.info.content.head.second": "NHN LINK는 정보통신망 이용촉진 및 정보보호 등에 관한 법률에 따라 아래와 같이 개인정보 제공에 대한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.",
		"delivery.personal.info.content.body.first": "1. 개인정보를 제공받는 자",
		"delivery.personal.info.content.body.second": "2. 제공하는 개인정보 항목",
		"delivery.personal.info.content.body.second.detail": ": 이름, 생년월일, 아이디, 휴대폰번호, (제공 시)이메일 주소, (배송 시)주문/배송정보",
		"delivery.personal.info.content.body.third": "3. 개인정보를 제공받는 자의 이용목적",
		"delivery.personal.info.content.body.third.detail": ": 티켓현장발권, 예매서비스 제공에 따른 내역 관리이행 등 티켓 예매 대행, 민원처리 등 고객상담, 서비스 분석과 통계에 따른 혜택 및 맞춤 서비스 제공, 서비스 이용에 따른 설문조사 및 혜택제공",
		"delivery.personal.info.content.body.fourth": "4. 개인정보를 제공받는 자의 개인정보 보유 및 이용기간",
		"delivery.personal.info.content.body.fourth.detail": ": 회원탈퇴 시 또는 개인정보 이용목적 달성 시까지. 단, 관계법령의 규정에 의해 보존의 필요가 있는 경우 및 사전 동의를 득한 경우 해당 보유기간까지",
		"delivery.personal.info.content.body.fifth": "5. 동의 거부권에 관한 공지",
		"delivery.personal.info.content.body.fifth.detail": "본 개인정보 제공에 동의하지 않으시는 경우, 동의를 거부할 수 있으며, 이 경우 상품구매가 제한될 수 있습니다.",
		"delivery.personal.agree.first": "위 취소정보를 확인했으며 이에 동의합니다.",
		"delivery.personal.agree.second": "개인정보 제 3자 제공에 동의합니다. (고객응대 및 관람정보안내 등을 위함)",
		...
		"booking.cancel.policy.info.first": "예매수수료는 예매일 이후 취소 시에는 환불되지 않습니다. 취소기한 및 취소수수료를 반드시 확인해주세요.",
		"booking.cancel.policy.info.second": "신용카드 결제를 취소하는 경우, 취소 시 부과된 취소 수수료를 예매 시 사용한 것과 동일한 카드로 재결제가 이루어집니다. 따라서 무이자 할부를 포함한 프로모션 및 혜택은 적용되지 않습니다.",
		"booking.cancel.policy.info.third": "티켓 분실 또는 파손된 경우 취소 및 변경을 할 수 없습니다.",
		"booking.cancel.policy.info.fourth": "공연기획사/구단 자체로 인해 발생한 문제로 인해 환불을 받을 경우 추가 취소 수수료가 부과되지 않으며, NHN 티켓 링크가 아닌 공연기획사/구단 운영자가 환불할 수 있습니다.",

		/* 얼럿 */
		"alert.product.max.count.per.person.exceed": "구매가능매수를 초과 선택했습니다. 해당 상품의 예매 가능한 잔여 매수는 {0}매입니다.",
		"alert.product.max.count.per.inning.exceed": "구매가능매수를 초과 선택했습니다. 해당 회차의 예매 가능한 잔여 매수는 {0}매입니다.",
		"alert.product.max.buy.count.per.inning.exceed": "경기 혹은 공연회차당 예매가능한 횟수를 초과했습니다. 해당 상품은 {0}회까지 예매 가능합니다. ",
		"alert.grade.max.count.per.inning.exceed": "구매가능매수를 초과 선택했습니다. 해당 등급의 예매 가능한 잔여매수는 {0}매입니다.",

		"alert.denom.max.count.per.person.exceed": "권종의 인당 최대 구매 매수 초과입니다.",
		"alert.denom.max.count.per.inning.exceed": "권종의 회차당 최대 구매 매수 초과입니다.",
		"alert.denom.max.buy.count.per.inning.exceed": "권종의 회차당 구매 횟수 초과입니다.",

		"alert.denom.max.schedule.sale.purchase.exceed": "회차당 판매가능 매수 초과 입니다.",
		"alert.denom.max.product.sale.purchase.exceed": "상품당 판매가능 매수 초과 입니다.",

		"alert.denomination.count.exceed": "권종 잔여 매수를 초과하였습니다 다시 확인해 주세요. : {0}",

		"alert.additionalproduct.count.exceed": "부가상품 잔여 매수를 초과하였습니다 다시 확인해 주세요.",
		"alert.additionalproduct.max.count.exceed": "{0}은 1인당 최대 {1}개 구매 가능하며, 한 회차당 {2}개씩 구매할 수 있습니다. 상품 개수를 다시 선택해 주세요.",

		"alert.already.preoccupancy": "이미 선점된 좌석입니다.",
		"alert.zone.count.exceed": "잔여 매수를 확인해주세요.",
		"alert.exhibition.count.exceed": "잔여 매수를 확인해주세요.",

		"alert.fail.auto.reserved": "지정석 자동선점으로 구매 가능한 매수가 부족합니다.\n구매 매수를 조정하시거나, [닫기] 버튼 클릭 후 [직접선택]을 이용해 주세요.",
		"alert.fail.auto.non.reserved": "비지정석 자동선점으로 구매 가능한 매수가 부족합니다.",

		"alert.seatzone.deatseat.leftorright": "좌(우)측에 사석이 발생하여 좌석선택이 완료되지 않았습니다.",
		"alert.seatzone.deatseat.seat.together": "연석 좌석에 사석이 발생하여 좌석 선택이 완료되지 않았습니다.",
	};
})();
...
tk.i18n.en = (function () {
	...
	return {
		...
		"NOTICE_ON_SEAT_PREOCCUPANCY_BODY": "If you and another customer selects identical seat simultaneously at this stage, the one who proceeds" +
		...
		"SEAT_TYPE_CAN_NOT_BE_PURCHASE_1": "These seat type can not be purchased together.\nPlease reset seat(s).",
		"SEAT_TYPE_CAN_NOT_BE_PURCHASE_2": "These seat type can not be purchased together.\nPlease reset seat(s).",
		"PURCHASE_TOTAL_MAXIMUM_N_TICKET": "You can purchase maximum {0} ticket(s) at once",
		"PURCHASE_GRADE_MAXIMUM_N_TICKET": "This seat type can purchase maximum {0} ticket(s) at once.",
		"THIS_IS_NOT_FOR_SALE": "This is not for sale.",
		"THERE_IS_NO_SEAT_AVAILABLE": "There is no seat to purchase.",
		"THERE_IS_NO_SEAT_AVAILABLE_FOR_PURCHASE": "There is no seat available for purchase.",
		"THERE_IS_NO_SEAT_AVAILABLE_ON_PRESALE_PERIOD": "There is no seat to purchase at pre-sale.",
		"PLEASE_SELECT_SEAT_OF_SAME_GRADE_AS_SELECTED_GRADE": "Please select a seat of the same grade as the selected grade.",
		"THIS_SEAT_TYPE_CAN_NOT_BE_PURCHASED_NOW": "This seat type can not be purchased now.",

		"CLEAN_RESERVATION_TITLE": "Clean reservation service",
		"CLEAN_RESERVATION_DESCRIPTION": "To prevent fraudulent reservations, you can make reservations after entering the security text message.",
		"CAPTCHA_AUTH_FAIL_MESSAGE": "Please enter it exactly.",
		"RESELECT_DATE": "Reselect Date",


		"SELECTED_SEAT_INFO_SELECT_GRADE": "Select a seat type, and then a seating selection type",
		...
		"SELECTED_TYPE_INFO_AUTO": " : Adjacent seats will be randomly assigned within your chosen seat type (Regardless of the selected area)",
		...
		"plan.seat.auto.info.body": " : Adjacent seats will be randomly assigned within your chosen seat type (Regardless of the selected area)",
		"plan.seat.self.info": "Seat selection",
		"plan.seat.self.info.body": " : select your seat within your chosen section",
		"plan.seat.auto.ticket.count": "Select quantity",
		"plan.seat.auto.selected.info": "Select number of tickets, and then [Next] button.",
		...
		"denomination.top.alert": "You have successfully occupied the selected seat.",
		"denomination.top.alert2": "You will complete the reservation if you pay within",
		"denomination.selected.seat": "Selected seat",
		"denomination.ticket.count": "seat(s)",
		"denomination.addOn.items": "Add-on Items",
		"denomination.addOn.items.info": "You may purchase below add-on items for the selected product.",
		"denomination.total.price": "Total Amount",
		"denomination.booking.fee": "Including Booking Fee",
		"denomination.won": "KRW",
		"denomination.grade.select.alert": "권종을 선택하세요. 최대 {0}매 까지 예매가능합니다.",
		...
		"delivery.reserver.confirm": "Name, birthday, phone number and email information are collected for providing discount to the booker and\
		...
		"delivery.standard.schedule": "All schedule are based on local time and date. (KST, GMT +9:00)",
		"delivery.personal.info.title": "Consent on providing the personal information to the 3rd party",
		"delivery.personal.info.content.head.first": "For the customers who wish to purchase product and services NHN Ticket Link offers, NHN Ticket Link \
  provides the minimum information required for customer consultation and notifying goods information as below.",
		"delivery.personal.info.content.head.second": "NHN Ticket Link \
  hereby notifies matters concerning personal information provision as below according to Act on Promotion of Information and Communication Network\
   Utilization and Information Protection. We ask you to thoroughly read the information and agree thereto.",
		"delivery.personal.info.content.body.first": "1. Personal information receiver",
		"delivery.personal.info.content.body.second": "2. Provided personal information",
		"delivery.personal.info.content.body.second.detail": ": name, birthday, ID, e-mail address, [Optional] cell phone number, [Delivery] order/delivery information.",
		"delivery.personal.info.content.body.third": "3. Purpose of use of the personal information receiver",
		"delivery.personal.info.content.body.third.detail": ": Notice on on-site ticket issuance, casting change and cancellation of show, Customer counseling, such as handling civil complaints, providing benefits and customized services according to service analysis and statistics, surveys and benefits according to service use.",
		"delivery.personal.info.content.body.fourth": "4. Period of retention and use of personal information",
		"delivery.personal.info.content.body.fourth.detail": ": Until the withdrawal of membership or the achievement of the purpose of using personal information. Provided, That if preservation is necessary pursuant to the provisions of the relevant statutes and if prior consent is obtained, until the relevant retention period.",
		"delivery.personal.info.content.body.fifth": "5. Notice on agreement refusal",
		"delivery.personal.info.content.body.fifth.detail": "If you fail to this provision on personal information, you can deny the provision and this case your product purchase is subject to be restricted.",
		"delivery.personal.agree.first": "I have read and agree to above cancel fee policy and cancel deadline.",
		"delivery.personal.agree.second": "I agree that the related information is provided to a third party for customer consultation and show info notice.",
		...
		"booking.cancel.policy.info.first": "The reservation fee can be refunded only when you cancel on the day of the reservation and it will not be refundable for cancellations made afterwards.",
		"booking.cancel.policy.info.second": "If you are revoking the payment made with your credit card, re-reservation will be made upon applying the \
  cancellation fee imposed at the time of cancellation with the same card used during initial purchase. Thus, seasonal promotion and benefits will not be applied including interest-free installment.\n",
		"booking.cancel.policy.info.third": "Please note that cancellation and change will not be available if you had lost or damaged your ticket.",

		/* 얼럿 */
		"alert.product.max.count.per.person.exceed": "You already purchased same product. So you can purchase only {0} ticket(s) at this product.",
		"alert.product.max.count.per.inning.exceed": "You already purchased same time. So you can purchase only {0} ticket(s) at this time. ",
		"alert.product.max.buy.count.per.inning.exceed": "You have exceeded the number of times you can purchase. This product can be purchased {0} times per time.",
		"alert.grade.max.count.per.inning.exceed": "You already purchased the same seat type. So you can purchase only {0} ticket(s) at this time.",

		"alert.denom.max.count.per.person.exceed": "You already purchased same time. So you can purchase only {0} ticket(s) at this time.",
		"alert.denom.max.count.per.inning.exceed": "You already purchased same time. So you can purchase only {0} ticket(s) at this time.",
		"alert.denom.max.buy.count.per.inning.exceed": "You already purchased same ticket(s). So you can purchase only {0} ticket(s) at this time.",

		"alert.denom.max.schedule.sale.purchase.exceed": "You can purchase {0} ticket(s).",
		"alert.denom.max.product.sale.purchase.exceed": "You can purchase {0} ticket(s).",

		"alert.denomination.count.exceed": "You can purchase {0} ticket(s).",

		"alert.additionalproduct.count.exceed": "There is no quantity available for purchase of the selected addendum.",
		"alert.additionalproduct.max.count.exceed": "You can purchase {0} additional product(s). So you can purchase only {1}additional product(s) at this time.",

		"alert.already.preoccupancy": "Another customer has occupied the selected seat. Please select another seat.",
		...
		"alert.fail.auto.reserved": "This is no adjacent seat by your chosen quantity. " +
			"Please confirm the quantity of seats available for purchase.",
		"alert.fail.auto.non.reserved": "There is no adjacent seat by your chosen quantity. Please confirm the quantity of seats available for" +
			" purchase.",

		"alert.seatzone.deatseat.leftorright": "You can't leave only single seat. Please select including the rest of the seats.",
		"alert.seatzone.deatseat.seat.together": "You can't leave only single seat. Please select including the rest of the seats.",
	};
})();
...
tk.i18n.ja = (function () {
	...
	return {
		...
		"NOTICE_ON_SEAT_PREOCCUPANCY_BODY": "現在の状態で座席を同時に選択した場合、先に次の手続きに進んだお客様が座席を確保することになります。 そのため、" +
		...
		"CLEAN_RESERVATION_TITLE": "Clean 予約サービス",
		"CLEAN_RESERVATION_DESCRIPTION": "否定の予約販売を防止するため、セキュリティの文字入力後、前売りが可能です。",
		"CAPTCHA_AUTH_FAIL_MESSAGE": "正確に入力してください。",
		"RESELECT_DATE": "日付をまた選択",

		"alert.additionalproduct.count.exceed": "選択した付加商品の購入可能数量がありません。",

		"SELECTED_SEAT_INFO_SELECT_GRADE": "Select a seat type first, then then a seating selection type",
		"SELECTED_SEAT_INFO_SELECT_AUTO": "Select a seat type and number of tickets",
		"SELECTED_SEAT_INFO_SELECT_DIRECT": "Select your seat",
		...
		"SELECTED_TYPE_DIRECT": "Seat selection",
		"SELECTED_TYPE_INFO_AUTO1": "Auto assignment : Adjacent seats will be randomly assigned within",
		"SELECTED_TYPE_INFO_AUTO2": "your chosen seat type (Regardless of the selected ",
		"SELECTED_TYPE_INFO_AUTO3": "area)",
		"SELECTED_TYPE_INFO_DIRECT": "Seat selection :select your seat within your chosen section"
	};
})();
...
tk.i18n.zh = (function () {
	...
	return {
		...
		"NOTICE_ON_SEAT_PREOCCUPANCY_BODY": "若在此状态多人同时选中座位时，谁先转至下一步谁先占座位。 因此，在选座位后移动至下一步的时点就会决定是否选完座位。" +
		...
		"SEAT_TYPE_CAN_NOT_BE_PURCHASE_2": "These seat type can not be purchased together.\nPlease reset seat(s).",
		"PURCHASE_TOTAL_MAXIMUM_N_TICKET": "You can purchase maximum {0}ticket(s).",
		"PURCHASE_GRADE_MAXIMUM_N_TICKET": "You can purchase maximum {0}ticket(s) at this time.",
		"THIS_IS_NOT_FOR_SALE": "This is not for sale.",
		"THERE_IS_NO_SEAT_AVAILABLE": "There is no seat to purchase.",
		"THERE_IS_NO_SEAT_AVAILABLE_FOR_PURCHASE": "There is no seat available for purchase.",
		"PLEASE_SELECT_SEAT_OF_SAME_GRADE_AS_SELECTED_GRADE": "Please select a seat of the same grade as the selected grade.",
		...
		"CLEAN_RESERVATION_TITLE": "Clean 预订服务",
		"CLEAN_RESERVATION_DESCRIPTION": "为防止非法预售,可在输入安全短信后进行预售。",
...
tk.api.ajax = (function () {
	 ...
	 */
	function _apiCallResponse (promise, opts) {
		var isOptsObject = typeof (opts) === 'object';
		var hasTimer = isOptsObject && opts.hasOwnProperty('timer') ? opts.timer : false;

		// 타이머 설정
		if (hasTimer) {
			var message = isOptsObject && opts.hasOwnProperty('message') ? opts.message : '';
			var timer = loading.start(1000 * 60 * 2, function () {
				//console.log("Api call fail : " + message);
			});
		}
		...
		promise.done(function (q) { // 성공시 액션
			...
			if (q.hasOwnProperty('result') && hasErrorCode(q.result)) {
				...
				//console.log("Api call fail " + '(' + q.result.code + ') : ' + message);
			} else if (hasErrorCode(q)) {
				error = {
					code: q.code,
					message: q.data
				};
				//console.log("Api call fail " + '(' + q.code + ') : ' + q.data);
			}
...
tk.api.reservePlan = (function () {
	...
	function _getGradesInBlock (opts) {
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Blocks Grades", promise.$promise);
	...
	function _getAllCanvasArea (_body, opts) {
		...
		var reqUrl = url + '/:scheduleId/seat-all/canverse/area';
		if (tk.utils.isWaitingReservation()) {
			reqUrl += waitingUrlQueryString();
		}
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Seat All Area", promise.$promise);
	...
	function _getAllCanvasBlock (_body, opts) {
		...
		var reqUrl = url + '/:scheduleId/seat-all/canverse/block';
		if (tk.utils.isWaitingReservation()) {
			reqUrl += waitingUrlQueryString();
		}
		var promise = ajax.post({
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Seat All Block", promise.$promise);
	...
	function _getAllCanvasBlockArea (_body, opts) {
		...
		var reqUrl = url + '/:scheduleId/seat-all/canverse/block2';
		if (tk.utils.isWaitingReservation()) {
			reqUrl += waitingUrlQueryString();
		}
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Seat All Block Area", promise.$promise);
	...
	function _getSeatSoldoutArea (_body, opts) {
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Seat Sold Out Area", promise.$promise);
	...
	function _getSeatSoldoutBlock (_body, opts) {
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Get Seat Sold Out Block Area", promise.$promise);
	...
	function _preOccupancy (_body, opts) {
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Preoccupancy", promise.$promise);
	...
	function _cancelPreOccupancy (_body, opts) {
		...
		apiCallResponse(promise.$promise, opts);
		tk.state.develop.debugTimeEndByPromise(tk.state.develop.DEBUG_TIME_TYPE.API, "[API] Cancel Preoccupancy", promise.$promise);
...
tk.util.reserve = (function () {
	...
	function _previousStep () {
		...
		if (meta.isSports && !_isFacility()) { // 스포츠의 경우 웹 시설을 제외하고 날짜회차가 없어서 종료
			if (_isAppWeb()) {
			...
			if (_isAppWeb()) { // 스포츠 앱 시설의 경우 날짜회차가 존재하지 않는다고 한다.
				location.href = 'ticketlink://closeWebView';
			} else {
				if (meta.productTypeCode === "SEASON_TICKET_SEAT") {
					...
					location.href = ("/reserve/product/" + meta.productId + "/schedule/sports?teamId="+homeTeamId).replace(/\s/gi, '');
				}
			}
		} else if (_isGlobal()) {
			location.href = ("/global/" + meta.locale + "/reserve/product/" + meta.productId).replace(/\s/gi, '');
		} else {
			//공연 상품 날짜/회차 페이지로 이동
			location.href = ("/reserve/product/" + meta.productId + "/schedule").replace(/\s/gi, '');
		}
	}
	...
	function _windowClose () {
		// FIXME KBL 종료후 삭제
		if (meta.kbl || meta.wkbl || meta.charlotte || meta.tMonet || meta.kleague) {
			if (_isAppWeb()) { // 스포츠 앱 시설의 경우 날짜회차가 존재하지 않는다고 한다.
				location.href = 'ticketlink://closeWebView';
			} else {
				// FIXME K-리그 임시 적용
	...
	function _checkLoadPrevious () {
		...
		if (!parsedUrl.queryKey.hasOwnProperty("loadPrevious") || parsedUrl.queryKey.loadPrevious !== "false") {
			return;
		}
	...
	function _checkDevice () {
		...
		var isAvailableCanvas = Modernizr.canvas && Modernizr.canvastext && Modernizr.canvaswinding;
	...
	function noticeNotAvailableDevice () {
		...
		if (meta.isSports) { // 스포츠의 경우 웹 시설을 제외하고 날짜회차가 없어서 종료
...
tk.state.global = (function () {
	...
	function _init (
		...
		if (globalLocale !== "ko") {
			tk.apis.init({reservePlan: initData.meta.schedule.scheduleId}, "", "/global/${globalLocale}/api/V2");
		} else {
			var scheduleId = '0000';
		...
		if (tk.utils.isWaitingReservation() && meta.frontPlanTypeCode === 'WAITING_APPLICATION') {
...
tk.state.plan = (function () {
	...
	scope.getGradeRemainCntAboutBlockAndGrade = getGradeRemainCntAboutBlockAndGrade;
	...
	function _init (meta, grades, product) {
		...
		tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.STATE, "Init Plan State");
		...
		scope.isKbl = meta.kbl;
		scope.isWkbl = meta.wkbl;
		scope.isKleague = meta.kleague;
		scope.isCoupang = meta.coupang;
		...
		if (meta.scheduleWaitingReservation && meta.scheduleWaitingReservation.hasOwnProperty('saleStatus')) {
			scope.scheduleWaitingReservation = {
				parsedSaleStartDate: tk.utils.momentFormat(meta.scheduleWaitingReservation.saleStartDatetime, DATE_FORMAT.IN_SALE),
				parsedSaleEndDate: tk.utils.momentFormat(meta.scheduleWaitingReservation.saleEndDatetime, DATE_FORMAT.IN_SALE),
		...
		if (scope.hasArea) {
			...
			scope.areaImageSize = scope.areaBgInfo.mapSize < mapSize ? scope.areaBgInfo.mapSize : mapSize;
			scope.areaImageUrlThumnail = reformatUrl(scope.areaBgInfo.imageUrlThumnail);
		...
		tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.STATE, "Init Plan State");
	}
	...
	function initPagingInfo (pagingInfo) {
		if (Array.isArray(pagingInfo)) {
			_.each(pagingInfo, function (paging) {
				...
				scope.pagingLoadCanvasMap[paging.virtualX + ":" + paging.virtualY] = false;
				scope.pagingLoadSoldoutMap[paging.virtualX + ":" + paging.virtualY] = false;
			});
		}
	}
	...
	function getGradeRemainCntAboutBlockAndGrade (block, grade) {
		...
		if (block === undefined ||
			grade === undefined || !Array.isArray(grades)) {
			return [null, null];
		}
	...
	function _setWaitingLinkedBySeat (seat) {
		if (!seat || seat.waitingLinkedId < 1) { // || seat.orderNum < 1
			return false;
		}
	...
	function _isNeedToPagingCall (key) {
		...
		return !scope.pagingLoadCanvasMap[key] || scope.pagingLoadCanvasMap[key] && !scope.pagingLoadSoldoutMap[key];
	}
...
tk.state.waitingDetail = (function () {
		...
		scope.verifyTicketCount = { // 좌석, 영역 신청 가능 횟수
			seatCnt: {
				cnt: 0,
				type: {
					name: '좌석'
		...
		function _init (detail) {
			...
			if (detail.typeList.length === 2) {
				...
				scope.reservationType = type === 'SEAT' ? RESERVATION_TYPE.SEAT : RESERVATION_TYPE.SECTION;
			}
		...
		function _move (step) {
			switch (step) {
				...
				case 1:
					// showPopup('gradeType');
					_showPopup(scope.useGradeSelect ? POPUP_TYPE.GRADE_TYPE : POPUP_TYPE.RESERVATION_TICKET);
					break;
				case 2:
		...
		function _selectReservationType (typeName, ignoreFlag) {
			...
			if (scope.currentTicketCount !== 0) {
				if (RESERVATION_TYPE[typeName].info.maxTicketCount < scope.currentTicketCount) {
					isEnable = false;
					isMaximum = false;
				}
			}
			...
			if (isChangeType || ignoreFlag) {
				...
				if (scope.currentTicketCount !== 0) {
					// 총 티켓값
					totalPayAmount = scope.reservationType.info.commission * scope.currentTicketCount;
			...
			if (pickGrade) {
				...
				for (var i = 0; i < gradesLimit.length; i++) {
					if (gradesLimit[i].productGradeId === productGradeId) {
						scope.ticketCount.max = gradesLimit[i].countLimitType === 'NONE' ? scope.reservationType.info.maxTicketCount : gradesLimit[i].cnt;
						break;
					}
				}
		...
		function _getAvailCount () {
			...
			var verifyCnt = scope.getReservationType() === 'SEAT'
		...
		function _selectTicket (count) {
			...
			if (count > 0) {
				if (scope.ticketCount.enable < count) {
					...
					alert('신청가능 매수를 초과 선택했습니다.\n해당 ' + name + '의 신청 가능한 잔여 매수는 ' + scope.ticketCount.enable + '매 입니다');
					return false;
				}

				if (scope.ticketCount.enableCnt.indexOf(count) === -1) {
					alert('취소표대기 신청 가능한 좌석/구역이 없습니다.\n필요한 매수를 변경 후 다시 확인 해 주세요.');
					return false;
				}

				if (tkSelectState.getTotalCnt() > maxTicketCount) {
					alert('선택된 좌석이 취소표 보다 많습니다.\n(최대 ' + maxTicketCount + '개 선택 가능)');
					return false;
				}
			}
		...
		function _isTicketDisable (count) {
			if (scope.useGradeSelect) {
				if (scope.currentGrade.hasOwnProperty('validCntList')) {
					if (!Array.isArray(scope.currentGrade.validCntList) || scope.currentGrade.validCntList.length === 0) {
						return false;
					}
			...
			return scope.ticketCount.enable < count || scope.ticketCount.enableCnt.indexOf(count) === -1;
		}
		...
		function _getAvailGrade () {
			...
			apiManager.reservePlan.waitingReservationGrades(body, {
				...
				timer: false,
					...
					var gradeSelect = q.data.filter(function (validGrade) {
		...
		function _getSectionInBlock () {
			...
			return blockInGradeKeys.filter(function (grade) {
				// 존재하는 영역만 필터링
				return grades[grade];
			}).map(function (grade) {
		...
		function _selectedSections (sectionInBlocks) {
			...
			var filterdSectionInBlocks = sectionInBlocks.map(function (block) {
		...
		function _selectedSectionsText (filterdSectionInBlocks) {
			...
			return filterdSectionInBlocks.map(function (block) {
...
tk.controller.data = (function () {
		...
		function updateReservationSeatDataByArea (seatGridIndexes) {
			tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Area");
			var isWaitingReservation = tk.utils.isWaitingReservation();
			var apis = [];
			var promise;
			...
			tk.utils.getPromiseAll(apis).done(function () {
				...
				tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Area");
		...
		function updateReservationSeatDataByAreaWithKey (keys) {
			tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Area With Key");
			var apis = [];
			var promise;
			...
			tk.utils.getPromiseAll(apis).done(function () {
				if (tk.utils.isWaitingReservation()) {
					...
					var seats = Object.keys(tkPlanState.seatSoldMap).filter(function (seatId) {
				...
				tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Area With Key");
		...
		function updateReservationSeatDataByBlock (blockIds) {
			tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Block");
			...
			tk.utils.getPromiseAll(apis).done(function () {
				...
				tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Block");
		...
		function updateReservationSeatDataBySector (blockId) {
			tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Sector");
			...
			tk.utils.getPromiseAll(apis).done(function () {
				...
				tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Reservation Seat Data By Sector");
				endWaitingLoading('updateReservationSeatDataBySector');
			});
		}
		...
		function updateAllCanvasByAreaWithKeys (keys) {
			...
			var pagingOpts = {
				...
				timer: false,
					...
					tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update All Canvas By Area With Key");
		...
		function updateAllCanvasByBlock (blockIds) {
			...
			var pagingOpts = {
				...
				timer: false,
					...
					if (!q.data || !q.data.hasOwnProperty('able')) { // 정보가 없을 때
						endWaitingLoading('updateAllCanvasByBlock');
						return;
					}
		...
		function updateSeatSoldoutByAreaWithKeys (keys) {
			tk.state.develop.debugTimeStart(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Seat Soldout By Area With Keys");
			...
			var soldOpts = {
				...
				timer: false,
					...
					tk.state.develop.debugTimeEnd(tk.state.develop.DEBUG_TIME_TYPE.DATA, "[Data] Update Seat Soldout By Area With Keys");
		...
		function preOccupancy (isAuto) {
			...
			return result.$promise.done(preOccupancySuccess);
		}
		...
		function preOccupancySuccess (q) {
			...
			if (q.hasOwnProperty('result') && tk.utils.hasErrorCode(q.result)) {
				if (q.result.code === 2000) { // 이미 선점하고 있는 경우 처리
					location.href = location.protocol + '//' + location.host + location.pathname;
					return;
				}
				actionWhenHasError();
		...
		function waitingPreOccupancySuccess (q) {
			...
			if (q.data !== undefined) { // 예매대기 신청하기 호출
		...
		function callPreOccupancy (isAuto) {
			if (tkViewState.isPreOccupancyLocked) { // 이미 선점 시도 중일 경우
				return null;
			}
			...
			if (isAuto) { // 자동배정
				...
				// 사석제어
				if (tkPlanState.isSports) { // 현재 스포츠의 경우만 사석 처리를 한다.
			...
			var preOccupancyOpts = {
				...
				timer: false,
					...
					if (data.result.message.indexOf('구매가능매수를 초과 선택했습니다') > -1) {
		...
		function setPreOccupancyDirect (preOccupancySeats, preOccupancyZones) {
			...
			for (var idx = 0; idx < selectedSeats.length; idx++) {
				...
				preOccupancySeats.push({
					...
					"area": selectedSeats[idx].area ? selectedSeats[idx].area : {
...
tk.controller.data = (function () {
	...
	function backToArea () {
		...
		if (tkViewState.isBgView() || tkViewState.isPartView()) {
			...
			// [예매대기전용]
			if (tk.utils.isWaitingReservation()) {
				// 뒤로가기로 선택된 영역을 해제함을 방지
				if (tk.state.waitingDetail.reservationType.type === RESERVATION_TYPE.SEAT.type) {
					if (tkSelectState.selectedGrade) {
...
tk.controller.view = (function () {
	...
	function gotoAreaPlan (eventType) {
		...
		} else if (eventType === MOBILE_AREA_TAB ||
			(tk.state.device.isMobile() && tk.state.view.isMobileSeatLayerOpen) // Mobile이고 Tab이 열려있다면
		) { // 모바일 등급 tab 여부에 따른 resizing
			TLSceneManager.getInstance().gotoAreaPlan(MOBILE_AREA_TAB);
		} else {
	...
	function _getBlockTooltip (block) {
		...
		for (var idx = 0; idx < grades.length; idx++) {
			...
			if (tk.utils.isWaitingReservation()) {
				...
				remainCnt = tkPlanState.isRemainExposure ? tkPlanState.getGradeRemainCntAboutBlockAndGrade(block, grade) : null;
...
TLLogicalSeatLayerBase.prototype.makeSeatImageTile = function (seatArray, key) {
	...
	for (var idx = seatArray.length - 1; idx >= 0; idx--) {
		...
		//this.offScreenContext.stroke();
		this.offScreenContext.fillStyle = gradeInfo ? gradeInfo.color : this.defaultGradeColor;
	...
	switch (TLG.PLAN_STATE) {
		case TLG.PLAN_AREA:
			...
			TLToolTipLayer.getInstance().setToolTip(
				(blockObj ? tk.controller.view.getBlockTooltip(blockObj) : null), event);
			break;
		case TLG.PLAN_SEAT:
			var seatInfo = TLSVGMatrixInfo.getInstance().selectSeatDetection();
			TLToolTipLayer.getInstance().setToolTip(
				(seatInfo ? tk.controller.view.getSeatTooltip(seatInfo) : null), event);
			if (seatInfo) {
				break;
			}
	...
	switch (TLG.PLAN_STATE) {
		...
		case TLG.PLAN_SEAT:
			if (TLSVGMatrixInfo.getInstance().scale <= 0.8) {
				if (!tk.state.plan.isPartExposure() && TLSVGMatrixInfo.getInstance().radian === 0) {
					try {
...
var TLMobileViewController = function () {
	...
	if (tk.state.device.isAOSSamsungMobileApp()) {
...
TLMobileViewController.prototype.onTap = function (event) {
	switch (TLG.PLAN_STATE) {
		case TLG.PLAN_AREA:
			var blockObj = TLSVGMatrixInfo.getInstance().selectAreaDetection(
				TLAreaBackgroundLayer.getInstance().areaMapScale, event);
			if (blockObj != null) {
				TLEventManager.getInstance().signals.c2a_selectBlockEvent.dispatch(blockObj);
			}
			break;
...
TLSVGMatrixInfoBase.prototype.uiAutoZoomIn = function (x, y) {
	var LT = this.screenToWorldBox.LT;
	var RB = this.screenToWorldBox.RB;
	...
	// if (this.radian !== 0) {
	// 	return;
	// 	var PREFIX_CENTER = 50;
	// 	var tx = zoomPercent.x - PREFIX_CENTER;
	// 	var ty = zoomPercent.y - PREFIX_CENTER;
	//
	// 	var radian = this.radian;
	//
	// 	// 회전 적용
	// 	var nx = (Math.cos(radian) * tx) - (Math.sin(radian) * ty);
	// 	var ny = (Math.sin(radian) * tx) + (Math.cos(radian) * ty);
	//
	// 	// 원래의 중심점으로 좌표를 돌려놓음
	// 	nx += PREFIX_CENTER;
	// 	ny += PREFIX_CENTER;
	//
	// 	zoomPercent.x = 100 - nx;
	// 	zoomPercent.y = 100 - ny;
	// }
	...
	var sum = {
		x: min.x < 0 ? Math.abs(min.x) + Math.abs(max.x) : max.x - min.x,
		y: min.y < 0 ? Math.abs(min.y) + Math.abs(max.y) : max.y - min.y,
	};

	var fixedCenterPosition = {
		x: Math.floor(min.x + (sum.x * (zoomPercent.x / 100))),
		y: Math.floor(min.y + (sum.y * (zoomPercent.y / 100)))
	};

	var moveBoundary = {
		x: {
			min: Math.min(this.moveScreenToWorldBoundary.LT.x, this.moveScreenToWorldBoundary.RB.x),
			max: Math.max(this.moveScreenToWorldBoundary.LT.x, this.moveScreenToWorldBoundary.RB.x),
		},
		y: {
			min: Math.min(this.moveScreenToWorldBoundary.LT.y, this.moveScreenToWorldBoundary.RB.y),
			max: Math.max(this.moveScreenToWorldBoundary.LT.y, this.moveScreenToWorldBoundary.RB.y)
		}
	};

	if (fixedCenterPosition.x < moveBoundary.x.min || moveBoundary.x.max < fixedCenterPosition.x) {
		// console.log('can\'t move X');
		return;
	}

	if (fixedCenterPosition.y < moveBoundary.y.min || moveBoundary.y.max < fixedCenterPosition.y) {
		// console.log('can\'t move Y');
		return;
	}

	var setScale = 1;
	var viewSizeOfPositionToMove = this.positionOfCalculateSlope(fixedCenterPosition, zoomPercent, setScale);

	this.uiMoveAnimation(this.worldCenterPosition, viewSizeOfPositionToMove, fixedCenterPosition, {x: x, y: y}, setScale);
};
...
TLSVGMatrixInfoBase.prototype.positionOfCalculateClickPoint = function (mapPositionOfClick, positionOfClickMouse, currentScale) {
	...
	var max = {
		x: mapPositionOfClick.x + (currentMapSize.x * (1 - clickPercent.x)),
		y: mapPositionOfClick.y + (currentMapSize.y * (1 - clickPercent.y)),
	};
...
/**
 * @description 클릭한 지점의 중앙 포지션을 찾는 기울기 함수
 * @param positionForCalculate
 * @param percentOfClickPosition
 * @param scale
 * @returns {{x: number, y: number}}
 */
TLSVGMatrixInfoBase.prototype.positionOfCalculateSlope = function (positionForCalculate, percentOfClickPosition, scale) {
	var xSlope;
	var ySlope;
	var xC = TLDomInfo.getInstance().getWidth();
	var yC = TLDomInfo.getInstance().getHeight();
	var epsilon = 0.00001; // tolerance for floating-point precision issues

	if (Math.abs(scale - this.scaleMin) < epsilon || scale < this.scaleMin) {
		xSlope = 0;
		ySlope = 0;
	} else {
		xSlope = Math.abs((this.mapSize - TLDomInfo.getInstance().getWidth()) / (this.scaleMin - scale));
		ySlope = Math.abs((this.mapSize - TLDomInfo.getInstance().getHeight()) / (this.scaleMin - scale));
		xC -= xSlope;
		yC -= ySlope;
	}

	var viewSize = {
		x: Math.max(0, xSlope * scale + xC),
		y: Math.max(0, ySlope * scale + yC),
	};

	return {
		x: Math.max(0, (positionForCalculate.x - (viewSize.x * 0.5)) + (viewSize.x * ((100 - percentOfClickPosition.x) / 100))),
		y: Math.max(0, (positionForCalculate.y - (viewSize.y * 0.5)) + (viewSize.y * ((100 - percentOfClickPosition.y) / 100))),
	};
};
 ...
 * @param current
 * @param target
 * @param mapPositionOfClick
 * @param origin
 * @param endScale
 */
TLSVGMatrixInfoBase.prototype.uiMoveAnimation = function (current, target, mapPositionOfClick, origin, endScale) {
	...
	function animate (timestamp) {
		...
		currentInstance.setAffineTransform(
			...
			_this.positionOfCalculateClickPoint(mapPositionOfClick, origin, currentScale),
			{x: width, y: height}
		);
...
var mainViewer = function () {
	...
	function drawDebug () {
		...
		domInfo.debugContext.fillText('matrix :' +
			matrixInfo.getMatrix().e.toFixed(1) + ',  ' +
			matrixInfo.getMatrix().f.toFixed(1),
			10, 10);
		domInfo.debugContext.fillText('base scale :' +
			matrixInfo.baseScale.toFixed(5),
			10, 22);
		domInfo.debugContext.fillText('scale :' +
			matrixInfo.scale.toFixed(5),
			10, 34);
		domInfo.debugContext.fillText('worldMousePos :' +
			matrixInfo.worldMousePosition.x.toFixed(0) + ',  ' +
			matrixInfo.worldMousePosition.y.toFixed(0),
			10, 46);
		domInfo.debugContext.fillText('worldCenterPos :' +
			matrixInfo.worldCenterPosition.x.toFixed(0) + ',  ' +
			matrixInfo.worldCenterPosition.y.toFixed(0),
			10, 58);
		domInfo.debugContext.fillText('worldScreenRadius :' +
			matrixInfo.worldScreenRadius.toFixed(5),
			10, 70);


		domInfo.debugContext.fillText('sectionWorldMatrix :' +
	...
	TLEventManager.getInstance().signals.resizeEvent.add(onResize);
...
var TLSceneManagerBase = function () {
	...
	TLEventManager.getInstance().signals.a2c_gotoAreaPlanEvent.add(this.gotoAreaPlan.bind(this));
	TLEventManager.getInstance().signals.a2c_gotoSeatPlanEvent.add(this.gotoSeatPlan.bind(this));
};
...
TLSceneManagerBase.prototype.setLayerInfo = function (data) {
	//영역 유무
	TLG.PLAN_STATE = data.physical.physicalPlan.blockPhysicalPlan ? TLG.PLAN_AREA : TLG.PLAN_SEAT;
	...
	if (data.physical.physicalPlan.blockPhysicalPlan) {
		...
		if (data.physical.physicalPlan.blockExposureFitRatio !== null && data.physical.physicalPlan.blockExposureFitRatio !== undefined &&
			data.physical.physicalPlan.blockExposureMinValue !== null && data.physical.physicalPlan.blockExposureMinValue !== undefined &&
			!data.physical.physicalPlan.blockExposureFitRatio &&
			data.physical.physicalPlan.blockExposureMinValue >= TLG.EXPOSURE_SCALE_MIN && data.physical.physicalPlan.blockExposureMinValue <= TLG.EXPOSURE_SCALE_MAX) {
			TLG.EXPOSURE_BLOCK_SCALE = data.physical.physicalPlan.blockExposureMinValue * 0.01;
		}
	}

	// 좌석 이미지 노출 스케일 조절
	if (data.physical.physicalPlan.areaExposureFitRatio === null || data.physical.physicalPlan.areaExposureFitRatio === undefined ||
		data.physical.physicalPlan.exposureMinValue === null || data.physical.physicalPlan.exposureMinValue === undefined) {
		TLG.EXPOSURE_SCALE = 1.0;
	} else {
		if (data.physical.physicalPlan.areaExposureFitRatio) {
			TLG.EXPOSURE_SCALE = TLDomInfo.getInstance().getWidth() / tk.state.plan.physical.bgInfo.mapSize;
		} else {
			if (data.physical.physicalPlan.exposureMinValue >= TLG.EXPOSURE_SCALE_MIN && data.physical.physicalPlan.exposureMinValue <= TLG.EXPOSURE_SCALE_MAX) {
	...
	if (data.physical.physicalPlan.planExposure) {
		var isSingleMap = data.physical.bgInfo.mapSize <= TLG.LOGICAL_SINGLE_MAP_SIZE;
		...
		var isSingleMap = data.physical.bgInfo.mapSize <= TLG.LOGICAL_SINGLE_MAP_SIZE;
		TLG.BACKGROUND_TYPE = isSingleMap ? TLG.BG_EXTENTION_SECTION_TILE : TLG.BG_SECTION_TILE;
	}
	...
	TLMiniMapLayer.getInstance().setLayerInfo(
		TLG.PLAN_STATE === TLG.PLAN_AREA ?
			data.physical.blockBgInfo : data.physical.bgInfo);
...
TLSceneManagerBase.prototype.setPlanState = function (state) {
	switch (state) {
		...
		case "NONE":
			...
			break;
		case MOBILE_AREA_TAB: // [영역도면] 모바일에서 tab 여부에 따른 center resizing
			TLDomInfo.getInstance().updateDomElement(); // DOM정보 업데이트
			TLG.PLAN_STATE = TLG.PLAN_AREA;
			TLDomInfo.getInstance().areaCanvas.style.display = 'block';
			TLDomInfo.getInstance().canvas.style.display = 'none';
			TLAreaBackgroundLayer.getInstance().updateLayer();
			TLSVGMatrixInfo.getInstance().setMoveBoundary();
			var center = TLAreaBackgroundLayer.getInstance().center;
			TLSVGMatrixInfo.getInstance().setWarpWorld(MOBILE_AREA_TAB, center.x, center.y);
			break;
	}
};
...
TLSceneManagerBase.prototype.gotoAreaPlan = function (eventType) {
	if (eventType === "BACK") {
		...
		this.setPlanState(MOBILE_AREA_TAB);
	} else {
...
// Scene Event Type
var MOBILE_AREA_TAB = 'MOBILE_AREA_TAB'; // 모바일 영역도면 등급선택 탭 case 이름
...
(function () {
	...
	angular
		.module('tklProject')
		.directive('tklSelectedSeatInfo', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/selectedSeatInfo/selectedSeatInfo' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
	...
	TklSelectedSeatInfoController.$inject = ['$scope', '$element', '$document', '$timeout', 'captcha', 'ticket'];
	 ...
	 */
	function TklSelectedSeatInfoController ($scope, $element, $document, $timeout, captcha, ticket) {
		...
		if (ctrl.isWaitingReservation) {
			...
			ctrl.isShowAvailableCountExposure = tkWaitingDetail.showAvailableCountExposure();
		...
		tkViewState.selectSeatInfo = angular.element($document[0].getElementById('select_seat_lst_area')); // 등급선택 엘리먼트
		// ------------------------------------
		...
		function activate () {
			...
			function updatedSelectedSeat () {
				...
				if (tkDeviceState.isMobile() && tkSelectState.isSelectSeatsAndZonesEmpty()) {
			...
			/**
			 * @description 등급선택 레이어에 따른 크기 변환에 대한 처리
			 */
			...
			function resizeView () {
				/**
				 * @desc mainView load 될 때 까지 재귀적 호출
				 */
				if (!tkViewState.mainView) {
					currentTimeoutCount++;
					if (timeoutCount <= currentTimeoutCount) {
						// do refresh or anything
						return;
					}
					setTimeout(function () {
						resizeView();
				...
				// 리사이즈 이벤트
				tk.event.view.signals.resizedView.dispatch();
				if (!isReady) {
					if (!tkPlanState.hasArea) {
			...
			if (ctrl.isWaitingReservation) {
				...
				function sectionMapUpdate () {
					...
					tk.event.ui.signals.updateMobileCss.dispatch({waitingTabShow: 'ignore'});
				}

				tk.event.service.signals.s2u_updatedSectionInBlock.add(updatedSelectedSection);
				...
				function updatedSelectedSection (updateObject) {
					if (updateObject) {
						if (updateObject.hasOwnProperty('isClear')) {
							...
							selectSection.map(function (currentSection) {
								ctrl.sectionInBlocks = ctrl.sectionInBlocks.map(function (block) {
									block.sections = block.sections.map(function (section) {
							...
							grades.map(function (currentGrade) {
								var idx = ctrl.sectionInBlocks.map(function (grade) {
								...
								ctrl.sectionInBlocks[idx].sections = ctrl.sectionInBlocks[idx].sections.map(function (section) {
					...
					//===== S: 선택된 좌석정보 업데이트 =====//
					var selectedSectionInBlockMap = JSON.parse(JSON.stringify(tkSelectState.selectedSectionInBlockMap));
					var selectedSectionMap = tkWaitingDetail.selectedSections(selectedSectionInBlockMap);
					var selectedMap = [];
				...
				ctrl.selectedSections = function () {
					var filterdSectionInBlocks = tkWaitingDetail.selectedSections(ctrl.sectionInBlocks);
				...
				ctrl.isSelectedAll = function () {
					var isSelected = tkWaitingDetail.isSectionSelectedAll(ctrl.sectionInBlocks);
				...
				ctrl.selectAll = function (isAllSelect) {
					...
					var sectionInBlocks = tkWaitingDetail.sectionSelectAll(ctrl.sectionInBlocks, isAllSelect);
					// 안내문구 노출 업데이트
		...
		function _isAutoShow () {
			var isSelectedTypeNone = ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.NONE;
			var isAutoProduct = isSelectedTypeNone && (tkPlanState.selectType === tkPlanState.SELECT_TYPE.AUTO);
			var isSelectedTypeAuto = ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.AUTO_SELECT;
			return (isAutoProduct || isSelectedTypeAuto) && !ctrl.selectState.hasSelectedSeats;
		}
		...
		function _isSelfShow () {
			var isSelectedTypeNone = ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.NONE;
			var isDirectProduct = isSelectedTypeNone && (tkPlanState.selectType === tkPlanState.SELECT_TYPE.DIRECT);
			var isSelectedTypeSelf = ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.SELF_SELECT;
		...
		function _isAutoSelfShow () {
			var isAutoSelfProduct = tkPlanState.selectType === tkPlanState.SELECT_TYPE.AUTO_DIRECT;
			var isSelectedTypeNone = ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.NONE;
			return isAutoSelfProduct && isSelectedTypeNone && !ctrl.selectState.hasSelectedSeats;
		}
		...
		function _selectedSeatLayerToggle () {
			...
			ctrl.viewState.isMobileSelectedSeatLayerOpen = !ctrl.viewState.isMobileSelectedSeatLayerOpen;

			if (ctrl.viewState.isMobileSelectedSeatLayerOpen && ctrl.viewState.isMobileSeatLayerOpen) {
				tkViewState.selectSeatInfo.css('display', 'block');
			}
...
(function () {
	...
	angular
		.module('tklProject')
		.directive('tklMainView', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/view/mainView' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
	...
	TklMainViewController.$inject = ['$scope', '$element', '$document', 'bigProductYn', 'captcha', 'ticket'];
	 ...
	 */
	function TklMainViewController ($scope, $element, $document, bigProductYn, captcha, ticket) {
		var ctrl = this;
		...
		ctrl.isViewAllView = ctrl.isWaitingReservation && ctrl.isSection;
		ctrl.bgSingle = '';
		...
		$scope.showNotSaleReservationWaiting = tk.utils.showNotSaleReservationWaiting;
		$scope.isWaitingReservationAvail = tk.state.plan.isWaitingReservationAvail;
		$scope.showReadyButton = tk.state.plan.isWaitingReservationAvail && tk.state.plan.scheduleWaitingReservation.saleStatus === WAITING_SALE_STATUS['BEFORE'];
		$scope.showInSaleButton = tk.state.plan.isWaitingReservationAvail && tk.state.plan.scheduleWaitingReservation.saleStatus === WAITING_SALE_STATUS['INSALE'];
		...
		function activate () {
			...
			function updateMobileCss (items) {
				if (items.hasOwnProperty('waitingTabShow')) {
					...
					// 모바일 구역형 탭 CSS조작을 위한 dispatch
					setTimeout(function () {
						var sectionArea = angular.element($document[0].getElementsByClassName('select_section_area')); // 등급선택 엘리먼트
						if (sectionArea[0]) {
							var height = sectionArea[0].clientHeight;
							tkViewState.mainView.css('bottom', (60 + height) + 'px');
							tk.event.view.signals.resizedView.dispatch();
						}
					}, 100);
				}
			 ...
			 * main view 진입점
			 */
			tk.event.view.signals.viewStandby.dispatch(tk.state.view.VIEW_TYPE.MAIN_VIEW);

			if (tk.state.device.isMobile()) {
				tk.event.view.signals.viewStandby.dispatch(tk.state.view.VIEW_TYPE.MINIMAP_VIEW);
			}
			...
			function updateStageDirection () {
				...
				stageDirection = angular.element($document[0].getElementById('stage_direction'));
		...
		function _refresh () {
			...
			tkWaitingDetailState.endLoading('refresh');
		}
		 ...
		 */
		function _isAutoShow () {
			var isAutoProduct = tkPlanState.selectType === tkPlanState.SELECT_TYPE.AUTO;
		...
		function _isAutoSelfShow () {
			var isAutoSelfProduct = tkPlanState.selectType === tkPlanState.SELECT_TYPE.AUTO_DIRECT;
			return isAutoSelfProduct && !tkSelectState.selectedGrade && !tkPlanState.hasArea;
		}
		...
		function _reservationTypeRefresh () {
			...
			tk.event.service.signals.updateReservationData.dispatch();
			tk.event.service.signals.updateReservationSeatData.dispatch();
			TLSceneManager.getInstance().setPlanState(tkPlanState.physical.physicalPlan.blockPhysicalPlan ? TLG.PLAN_AREA : TLG.PLAN_SEAT);
			tk.event.ui.signals.updateSelectedGrade.dispatch();
...
(function () {
		...
		.directive('tklSeatGradeSelect', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/seatGrade/seatGradeSelect' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
		...
		.directive('tklSeatGrade', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/seatGrade/seatGrade' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
		...
		.directive('tklZoneGrade', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/seatGrade/zoneGrade' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
	...
	TklSeatGradeSelectController.$inject = ['$scope', '$element', '$timeout', '$document', '$rootScope'];
	 ...
	 */
	function TklSeatGradeSelectController ($scope, $element, $timeout, $document, $rootScope) {
		var ctrl = this;
		...
		var selectSeatGradeElement = angular.element($document[0].getElementById('select_seat_grade'))[0];
		var selectSeatZoneElement = angular.element($document[0].getElementById('select_seat_zone'))[0];
		...
		function activate () {
			tk.event.service.signals.updatedReservationData.add(updatedReservationData);
			...
			function updatedReservationData () {
				...
				if (selectedGrade) {
					ctrl.zones = tkPlanState.getBlocksInGradeByGradeId(selectedGrade.gradeId);
			...
			tk.event.service.signals.s2u_gradeLoadingToggle.add(s2u_gradeLoadingToggle);
			...
			function gradeClear () {
				...
				if (tk.utils.isWaitingReservation()) {
					...
					tkSelectState.setSelectedBlocks(tk.state.waitingDetail.getDefaultBlocks());
					return;
				} else {
					tkSelectState.setSelectedGrade(null);
					tkSelectState.setSelectedBlocks([]);
			...
			if (tkDeviceState.isMobile()) {
				...
				$scope.$watch(function () {
					...
					if (ctrl.zoneSelected) {
						...
						ctrl.oldZoneSelected = angular.element($document[0].getElementById('block_' + oldBlockId));
					...
					ctrl.zoneSelected = angular.element($document[0].getElementById('block_' + blockId));
		...
		function _select (evt, idx, grade) {
			...
			if (tkPlanState.hasArea) {
				if (tkDeviceState.isMobile()) {
					tk.event.view.signals.gotoAreaPlan.dispatch(MOBILE_AREA_TAB);
				} else {
					tk.event.view.signals.gotoAreaPlan.dispatch();
				}
			}
		...
		function isTargetNoticeOnMobile (evt) {
			if (evt === undefined) { // 이벤트가 없는 경우
				return false;
			}

			if (!tkDeviceState.isMobile()) { // 모바일이 아닌 경우
				return false;
			}
			var isNotANode = evt.target.nodeName !== "A"; // A 이면 등급, SPAN 이면 등급 안내
			var hasClassMarker = tk.utils.includes.call(evt.target.className, 'notice_marker'); // 등급 이름과 등급 안내 구분
		...
		function reCalculateScrollByGrade (grade) {
			...
			var target = angular.element($document[0].getElementById('seat_grade_' + grade.gradeId))[0];
		...
		function reCalculateScrollByBlock (block) {
			...
			var parent = selectSeatZoneElement;
			var target = angular.element($document[0].getElementById('seat_zone_' + block.blockId))[0];

			if (!target) {
				$timeout(function () {
					target = angular.element($document[0].getElementById('seat_zone_' + block.blockId))[0];
					reCalculateScroll(parent, target);
				}, 100);
			}
		...
		function _zoneSelect (evt, idx, block) {
			...
			if (tkViewState.isViewOn()) {
				tkSelectState.setSelectedBlocks([block]);
				if (tkPlanState.isPartExposure()) { // 부분노출 영역 이동
		...
		function getIsShowZones () {
			if (ctrl.prevSelected < 0) { // 등급이 선택되었는지
				return false;
			}

			if (!tkPlanState.hasArea) { // 영역이 있는 도면인지
				return false;
			}

			if (tk.utils.isWaitingReservation()) { // 예매대기인 경우
				return true;
			}

			if (tkPlanState.selectType === tkPlanState.SELECT_TYPE.DIRECT) { // 직접선택만 있는 도면인지
				return true;
			}

			return ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.SELF_SELECT // 선택유형이 직접선택인지
				&& ctrl.zones.length > 0 // 해당 등급에 영역이 존재하는지
				&& ctrl.selectState.isGradeSelected(); // 선택 상태에서 등급이 선택되어 있는지
		}
		...
		function _isNeedEmptyGrade () {
			...
			if (!Array.isArray(ctrl.zones) || ctrl.grades.length >= ctrl.zones.length) {
				return false;
			}
	...
	function TklSeatGradeController ($scope, $timeout, $document) {
		...
		function activate () {
			...
			function isNeedToZone () {
				if (ctrl.depth !== 1) { // 등급이 아닌 경우 통과, 1 : 등급, 2 : 영역
					return false;
				}

				if (!ctrl.selected) { // 선택되지 않았으면 통과
					return false;
				}

				if (!tkSelectState.selectedGrade || !ctrl.grade) { // 선택된 등급이나 등급이 없으면 통과
					return false;
				}
		...
		function _isShowBtn () {
			...
			if (ctrl.depth !== 1) { // 깊이가 1 여부
				return false;
			}

			if (!ctrl.selected) { // 등급 선택 여부
				return false;
			}

			if (ctrl.selectState.selectedType !== ctrl.selectState.SELECTED_TYPE.NONE) { // 선택 타입이 없음으로 설정 여부
				return false;
			}
		...
		function _isShowZones () {
			if (ctrl.isShowBtn()) { // 선택 버튼이 올라와있는지 여부
				return false;
			}
			...
			if (ctrl.selectState.selectedType === ctrl.selectState.SELECTED_TYPE.AUTO_SELECT) { // 선택 타입이 자동으로 설정 여부
				return false;
			}
		...
		function reCalculateScroll (parent, target) {
			...
			$timeout(function () {
				var top = target.offsetTop + target.parentNode.parentNode.offsetTop - parent.clientHeight * 0.5;
...
(function () {
	...
	angular
		.module('tklProject')
		.directive('tklPopupAutoSeatSelect', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/popup/popupAutoSeatSelect' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
	...
	function TklPopupAutoSeatSelectController ($scope) {
		...
		function activate () {
			...
			function popupAutoSelect (grade) {
				...
				ctrl.increaseInterval = grade.groupSeatCount < 1 ? 1 : grade.groupSeatCount;
		...
		function _increaseBtnClick (value) {
			...
			tkSelectState.updateAutoSelectCount(ctrl.grade, ctrl.selectState.autoSelectCount + value);
		}
...
(function () {
	...
	angular
		.module('tklProject')
		.directive('tklPopupCaptcha', function () {
			return {
				templateUrl: function () {
					var tkDeviceState = tk.state.device;
					var template = tkDeviceState.getTemplateOfDevice();
					return tk.utils.addQueryTime('/resources/jsdev/reserve/seat/ui/component/popup/popupCaptcha' + template + '.html');
				},
				transclude: true,
				replace: true,
				scope: {},
	...
	TklPopupCaptchaController.$inject = ['$rootScope', 'captcha', '$http', '$scope'];

	/**
	 * @description dimmed 컨트롤러
	 */
	function TklPopupCaptchaController ($rootScope, captcha, $http, $scope) {
		var ctrl = this;
		...
		var _captchaImg = document.getElementById('captcha_img');
		var _captchaImgRefreshTimeoutId;

		ctrl.isDisplayed = captcha.needAuth;
		ctrl.captchaImageSrc = captcha.captchaKey ? '/captcha/image?captchaKey=' + captcha.captchaKey + getTimeQuery() : '';
		...
		ctrl.focusCaptchaInputAndHideAuthInvalid = _focusCaptchaInputAndHideAuthInvalid;
		...
		function _init () {
			...
			_captchaImg.addEventListener('load', function () {
		...
		function _refresh (needResetRefreshTimer) {
			...
			ctrl.captchaImageSrc = origin[0] + getTimeQuery();
		...
		function _goToPrevStep () {
			if(_tkPlanState.isKbl || _tkPlanState.isWkbl || _tkPlanState.isKleague || _tkPlanState.isCoupang){
				tk.utils.windowClose();
			}else{
		...
		function _requestAuth () {
			$http.post('/captcha/auth/' + captcha.captchaKey, {answer: ctrl.inputData})
				.then(function (res) {
					if (res.data.result.code === 777) {
						alert('보안문자 유효 3분이 지났습니다. 이미지를 새로고침 해주세요.');
						return;
				...
				.finally(function () {
					var isDelayNeeded = window.isAppWeb && _isIOS() && ctrl.lastClickedElement === 'input';
					if (!ctrl.isDisplayed) {
						setTimeout(function () {
		...
		function _isMobile () {
			var entries = /Android|BlackBerry|iPhone|iPad|iPod|iOS|Opera Mini|IEMobile/i;

...
import TlBaseball from "./presenter";
...
class Container extends Component {
  ...
  static propTypes = {
    getBaseballBlockObj : PropTypes.func.isRequired,
  ...
  componentDidMount() {
    const {getBaseballBlockObj } = this.props;
	const lastSegment = window.location.pathname.split("/").pop();
	getBaseballBlockObj(lastSegment)
	//document.addEventListener('click', this.handleDocumentClick);
	document.title = 'T사 야구('+lastSegment+') 티켓팅 연습';
  ...
  render() {
    return (
      <TlBaseball startTimer={this.startTimer} clickReplay={this.clickReplay} clickNext={this.clickNext} allView={this.allView} {...this.state} {...this.props} popupClose={this.popupClose} btnBlockClick={this.btnBlockClick} selectGrade={this.selectGrade} btnGradeClick={this.btnGradeClick} />
    );
  }
}

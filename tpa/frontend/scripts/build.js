...
function obfuscateCode() {
  ...
  const directoryPath = paths.appBuild; // 수정이 필요한 경우 경로를 변경하세요.
  ...
  fileNames.forEach(fileName => {
    ...
    if (stats.isFile() && path.extname(filePath) === '.js') {
      ...
      const obfuscationResult = JavaScriptObfuscator.obfuscate(fileContent, {
        ...
        // 추가 옵션을 원한다면 documentation을 참조하세요: https://github.com/javascript-obfuscator/javascript-obfuscator#options
      });
